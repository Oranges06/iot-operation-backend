...
public class MqttConfig {
    ...
    @PostConstruct
    public void init() {
        clientId = "clientId_"+ RandomUtil.randomInt(1, 1000);
    ...
    public MqttPahoMessageDrivenChannelAdapter mqttInboundAdapter() {
        // 群组共享订阅:$share/{group}/{topic}
        // 不带群组的共享订阅:$queue/{topic}
        String sharedTopic = "$queue/"+ DeviceTopicEnum.COMMAND_RESPONSE.getWildcard();
